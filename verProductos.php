        ...
        <div class="container py-md-5 py-3">
            <div class="container text-center">
                <div class="row">
                    <div class="col-12">
                        <div class="container">
                            <div id="animated-title">PRODUCTOS</div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><button type=" button" class="btn btn-warning" data-bs-toggle="modal"
                                                    data-bs-target="#exampleModal<?php echo $key['idProductos'] ?>"><i
                                                        class="bi bi-pencil-square"></i></button>
                                                <a href="./controller/eliminarProd.php?id=<?php echo $key['idProductos'] ?>"
                                            ...
                                            <td><button type=" button" class="btn btn-warning" data-bs-toggle="modal"
                                                    data-bs-target="#exampleModal<?php echo $key['idProductos'] ?>"><i
                                                        class="bi bi-pencil-square"></i></button>
                                                <a href="./controller/activarPrdo.php?id=<?php echo $key['idProductos'] ?>"
                                                    class="btn btn-success"><i class="bi bi-check2-all"></i></a>
                                                <?php
                                            }
                                            ?>
                                        </tr>
                                        <div class="modal fade" id="exampleModal<?php echo $key['idProductos'] ?>"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="./controller/editarProd.php" method="post">
                                                            <input type="hidden" name="idProd"
                                                                value="<?php echo $key['idProductos'] ?>">
                                                            <div class=" mb-3">
                                                                <label for="productoEdit" class="form-label">Producto a
                                                                    Editar:</label>
                                                                <input type="text" style="text-align: center;"
                                                                    value="<?php echo $key['nombre']?> MEDIDAS <?php echo $key['medidas']?>"
                                                                    class="form-control" id="productoEdit" readonly>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="precioEdit"
                                                                    class="form-label">Precio:</label>
                                                                <div class="input-group">
                                                                    <span class="input-group-text"><i
                                                                            class="bi bi-currency-dollar"></i></span>
                                                                    <input type="number"
                                                                        value="<?php echo $key['precio']?>" min="1"
                                                                        required class="form-control" name="precioEdit"
                                                                        id="precioEdit" placeholder="Ingrese el precio">
                                                                </div>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="pesoEdit" class="form-label">Peso:</label>
                                                                <div class="input-group">
                                                                    <span class="input-group-text"><i
                                                                            class="bi bi-percent"></i></span>
                                                                    <input value="<?php echo $key['peso']?>" type="text"
                                                                        min="1.0" required class="form-control"
                                                                        name="pesoEdit" id="pesoEdit"
