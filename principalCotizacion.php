    ...
    <section class="w3l-passion-sec2 py-5" style="margin-top: 20%">
        <div class="container py-md-5 py-3">
            <div class="container text-center">
                <div class="row">
                    <div class="col-md-6">
                        <a href="./verCotizaciones.php" class="highlight-link">
                            <div class="d-flex justify-content-center align-items-center h-100">
                                <div class="text-center">
                                    <i style="color: white;" class="bi bi-eye display-1"></i>
                                    <h1 style="color: white;">Ver Cotizaciones</h1>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-6">
                        <a href="./verProductos.php" class="highlight-link">
                            <div class="d-flex justify-content-center align-items-center h-100">
                                <div class="text-center">
                                    <i style="color: white;" class="bi bi-pencil display-1"></i>
                                    <h1 style="color: white;">Editar Productos</h1>
                                </div>
                            </div>
                        </a>
                    </div>
